...
void UGDAttributeSetBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UGDAttributeSetBase, TestValue, COND_None, REPNOTIFY_Always);
}
...
void UGDAttributeSetBase::OnRep_TestValue(const FGameplayAttributeData& OldTestValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UGDAttributeSetBase, TestValue, OldTestValue);
}
