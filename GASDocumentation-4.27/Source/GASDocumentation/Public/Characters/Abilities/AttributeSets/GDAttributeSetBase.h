...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "TestValue", ReplicatedUsing = OnRep_TestValue)
	FGameplayAttributeData TestValue;
	ATTRIBUTE_ACCESSORS(UGDAttributeSetBase, TestValue)
...
protected:
	...
	**/
	...
	UFUNCTION()
	virtual void OnRep_TestValue(const FGameplayAttributeData& OldTestValue);
