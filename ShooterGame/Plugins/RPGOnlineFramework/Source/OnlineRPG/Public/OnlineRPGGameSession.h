...
#include "OnlineRPGGameSession.generated.h"

struct FOnlineRPGGameSessionParams
{
...
UCLASS(config=Game)
class ONLINERPG_API AOnlineRPGGameSession : public AGameSession
{
...
protected:
	...
	FOnlineRPGGameSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FOnlineRPGOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FOnlineRPGOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(AOnlineRPGGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(AOnlineRPGGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(AOnlineRPGGameSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AOnlineRPGGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
