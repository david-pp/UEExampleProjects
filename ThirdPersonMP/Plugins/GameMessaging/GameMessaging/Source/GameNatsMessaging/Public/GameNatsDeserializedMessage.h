 ...
 */
class FNatsDeserializedMessage
...
public:
	 ...
	 */
	FNatsDeserializedMessage(const TSharedPtr<IMessageAttachment, ESPMode::ThreadSafe>& InAttachment);

	/** Virtual destructor. */
	virtual ~FNatsDeserializedMessage() override;
