...
class FGameTcpDeserializedMessage;

/** Delegate type for announcing a connection state change */
DECLARE_DELEGATE(FOnGameTcpMessageTransportConnectionStateChanged)
...
class FGameTcpMessageTransportConnection
	: public FRunnable
	, public TSharedFromThis<FGameTcpMessageTransportConnection>
 {
public:
	 ...
	 */
	FGameTcpMessageTransportConnection(FSocket* InSocket, const FIPv4Endpoint& InRemoteEndpoint, int32 InConnectionRetryDelay);

	/** Virtual destructor. */
	virtual ~FGameTcpMessageTransportConnection();
	 ...
	 * @see Send
	 */
	bool Receive(TSharedPtr<FGameTcpDeserializedMessage, ESPMode::ThreadSafe>& OutMessage, FGuid& OutSenderNodeId);
	 ...
	 * @see Receive
	 */
	bool Send(FGameTcpSerializedMessagePtr Message);
	...
	*
	* @return FOnGameTcpMessageTransportConnectionStateChanged delegate
	*/
	FOnGameTcpMessageTransportConnectionStateChanged& OnGameTcpMessageTransportConnectionStateChanged()
	{
...
private:
	...
	FOnGameTcpMessageTransportConnectionStateChanged ConnectionStateChangedDelegate;
	...
	TQueue<TSharedPtr<FGameTcpDeserializedMessage, ESPMode::ThreadSafe>, EQueueMode::Mpsc> Inbox;
	...
	/** Peer's value for of EGameTcpMessagingVersion::LatestVersion */
